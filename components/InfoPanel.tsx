...
const FeatureCard: React.FC<{ icon: React.ReactElement; title: string; children: React.ReactNode }> = ({ icon, title, children }) => (
    <div className="flex flex-col items-center text-center p-6 bg-gray-50 dark:bg-gray-900/50 rounded-lg">
...
const InfoPanel: React.FC<InfoPanelProps> = ({ onConnectClick }) => {
  return (
    <div className="bg-white dark:bg-gray-800 shadow-lg rounded-xl overflow-hidden mt-8">
        <div className="p-8 md:p-12">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
             ...
             <div className="mt-12 text-center bg-gray-100 dark:bg-gray-900/50 p-8 rounded-lg">
            ...
            <div className="mt-12 text-center">
                <h4 className="font-semibold text-gray-800 dark:text-gray-200">Powered by Modern Technology</h4>
